...
교재는 영상 서비스와 전자상거래 서비스를 대표 사례로 설명합니다. 실제 화면을 복제하는 대신, 각 서비스에서 추천이 해결하는 질문을 비교해 봅시다.

| 영역 | 후보 | 추천이 답하려는 질문 |
|---|---|---|
| 영상 | 영화와 시리즈 | 지금 이 사용자가 보고 싶어 할 콘텐츠는 무엇인가? |
| 쇼핑 | 상품 | 이 사용자의 목적과 관심에 맞는 상품은 무엇인가? |
| 음악 | 곡과 플레이리스트 | 지금 상황과 취향에 어울리는 음악은 무엇인가? |
| 뉴스 | 기사 | 이 독자가 관심을 가질 가능성이 높은 기사는 무엇인가? |
